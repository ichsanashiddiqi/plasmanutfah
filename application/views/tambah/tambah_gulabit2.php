        ...
        <div class="card-body">
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="paspor">
                    ...
                    <form class="user" method="post" action="<?php echo base_url('add/add_gulabit/tambah_pas'); ?>">
                ...
                <div role="tabpanel" class="tab-pane" id="foto">
                    ...
                    <?= form_open_multipart('add/add_gulabit/tambah_foto'); ?>
                    <div class="form-group row">
                ...
                <div role="tabpanel" class="tab-pane" id="stok">
                    <form class="user" method="post" action="<?php echo base_url('add/add_gulabit/tambah_benih'); ?>">
                        <div class="col-sm">
                            <input class="form-control" type="text" name="no_aksesi" id="no_aksesi" value="<?php foreach ($aksesi as $aks) {
                                                                                                                # code...
                                                                                                                echo $aks->no_aksesi;
