            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="paspor">
                    ...
                    <form class="user" method="post" action="<?php echo base_url('add/add_abaka/tambah_pas'); ?>">
                        <div class="form-group row">
                            <div class="col-sm">
                                <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?php foreach ($dat_abaka as $k) {
                                                                                                                    # code...
                                                                                                                    echo $k->no_aksesi;
                                                                                                                } ?>" readonly>
                            </div>
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control" id="Image_nama" name="Image_nama" value="<?php $foto->Image_name; ?>">
                            </textarea>
                                </div>
                            </div>
                            <div class="form-group row">
