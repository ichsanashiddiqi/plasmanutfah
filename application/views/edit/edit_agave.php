            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="paspor">
                    ...
                    ?>
                        ...
                        ?>
                            <form class="user" action="<?php echo base_url('edit_plant/edit_agave/pas_agave'); ?>">
                    ...
                    <form class="user" method="post" action="<?php echo base_url('add/add_agave/tambah_pas'); ?>">
                        <div class="form-group row">
                            <div class="col-sm">
                                <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?php foreach ($dat_agave as $k) {
                                                                                                                    # code...
                                                                                                                    echo $k->no_aksesi;
                                                                                                                } ?>" readonly>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane" id="foto">
                    ...
                    <?php
                    foreach ($foto_agave as $foto) {
                    ?>
                        <?php if ($foto->no_aksesi > 0) {
                        ?>
                            <form class="user" method="post" action="<?php echo base_url('add/add_agave/tambah_foto'); ?>">
                                <div class="form-group row">
                    ...
                    <form class="user" method="post" action="<?php echo base_url('add/add_agave/tambah_foto'); ?>">
                        <div class="form-group row">
                            <label for="nama_file" class="col-sm-2 col-form-label">No. Aksesi</label>
                            <div class="col-sm">
                                <input class="form-control" type="text" name="no_aksesi" id="no_aksesi" value="<?php foreach ($dat_agave as $k) {
                                                                                                                    # code...
                                                                                                                    echo $k->no_aksesi;
                                                                                                                } ?>" readonly>
                            </div>
