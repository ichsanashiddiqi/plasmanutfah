        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="foto">
                    ...
                    <?php
                    foreach ($foto_kapas as $foto) {
                    ?>
                        <?php if ($foto->image > 0) {
                        ?>

                            <form class="user" method="post" action="<?php echo base_url('edit/edit_kapas/edit_kapas'); ?>">
                                <div class="form-group row">
                    ...
                    <?php foreach ($foto_kapas as $k) {
                    ?>
                        <?php if ($k == null) { ?>
                            <form class="user" method="post" action="<?php echo base_url('add/add_kapas/tambah_foto'); ?>">
                                <div class="form-group row">
                                    <label for="nama_file" class="col-sm-2 col-form-label">No. Aksesi</label>
                                    <div class="col-sm">
                                        <input class="form-control" type="text" name="no_aksesi" id="no_aksesi" value="<?php foreach ($dat_kapas as $k) {
                                                                                                                            # code...
                                                                                                                            echo $k->no_aksesi;
                                                                                                                        } ?>">
                                    </div>
