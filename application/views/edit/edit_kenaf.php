        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="paspor">
                    ...
                    <form class="user" method="POST" action="<?= base_url('edit_plant/edit_kenaf/pas_kenaf'); ?>">
                        <?php
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" method="post" action="<?php echo base_url('add/add_kenaf/tambah_pas2'); ?>">
                                        <div class="form-group row">
                                            <?php  foreach ($dat_kenaf as $kps) { ?>
                                            <div class="col-sm">
                ...
                <div role="tabpanel" class="tab-pane" id="foto">
                    ...
                    <?php
                        foreach ($foto_kenaf as $pas) {
                        ?>
                    <!-- <form class="user" method="POST" action="<?= base_url('edit_plant/edit_kenaf/tambah_foto'); ?>"> -->
                    <?= form_open_multipart('edit_plant/edit_kenaf/tambah_foto'); ?>
                    <div class="form-group row">
                        <div class="col-sm">
                            <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $pas['no_aksesi']; ?>" readonly>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?= form_open_multipart('add/add_kenaf/tambah_foto2'); ?>
                                    <div class="form-group row">
                                        <?php  foreach ($dat_kenaf as $kps) { ?>
                                        <div class="col-sm">
                                            <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $kps['no_aksesi']; ?>" readonly>
                ...
                <div role="tabpanel" class="tab-pane" id="stok">
                    <?php foreach ($benih_kenaf as $aks) { ?>

                    <form class="user" method="post" action="<?php echo base_url('edit_plant/edit_kenaf/tambah_benih'); ?>">
                        <div class="col-sm">
                    ...
                    <div class="modal fade modalfoto" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" method="post" action="<?php echo base_url('add/add_kenaf/tambah_benih2'); ?>">
                                        <div class="form-group row">
                                            <?php  foreach ($dat_kenaf as $kps) { ?>
                                            <div class="col-sm">
                                                <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $kps['no_aksesi']; ?>" readonly>
