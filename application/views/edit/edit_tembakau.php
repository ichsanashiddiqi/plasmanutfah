<div class="container-fluid">
    ...
    <div class="card text-left">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="paspor">
                    ...
                    ?>
                        ...
                        ?>
                            <form class="user" action="<?php echo base_url('edit_plant/edit_tembakau/pas_tembakau'); ?>">
        ...
        <form class="user" method="post" action="<?php echo base_url('add/add_tembakau/tambah_pas'); ?>">
            <div class="form-group row">
                <div class="col-sm">
                    <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?php foreach ($dat_tembakau as $k) {
                                                                                                        # code...
                                                                                                        echo $k->no_aksesi;
                                                                                                    } ?>" readonly>
                </div>
            ...
            <div role="tabpanel" class="tab-pane" id="foto">
                ...
                <?= form_open_multipart('add/add_tembakau/tambah_foto'); ?>
                <div class="form-group row">
