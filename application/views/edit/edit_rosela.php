        ...
        <div class="card-body">
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="karakter">
                    ...
                    foreach ($dat_rosela as $kps) {
                    ?>
                    <form class="user" method="post" action="<?php echo base_url('edit_plant/edit_rosela/kar_rosela'); ?>">
                ...
                <div role="tabpanel" class="tab-pane" id="paspor">
                    ...
                    <form class="user" method="POST" action="<?= base_url('edit_plant/edit_rosela/pas_rosela'); ?>">
                        <?php
                        foreach ($pas_rosela as $pas) {
                        ?>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" method="post" action="<?php echo base_url('add/add_rosela/tambah_pas2'); ?>">
                                        <div class="form-group row">
                                            <?php  foreach ($dat_rosela as $kps) { ?>
                                            <div class="col-sm">
                ...
                <div role="tabpanel" class="tab-pane" id="foto">
                    ...
                    <?php
                        foreach ($foto_rosela as $pas) {
                        ?>
                    <!-- <form class="user" method="POST" action="<?= base_url('edit_plant/edit_rosela/tambah_foto'); ?>"> -->
                    <?= form_open_multipart('edit_plant/edit_rosela/tambah_foto'); ?>
                    <div class="form-group row">
                        <div class="col-sm">
                            <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $pas['no_aksesi']; ?>" readonly>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?= form_open_multipart('add/add_rosela/tambah_foto2'); ?>
                                    <div class="form-group row">
                                        <?php  foreach ($dat_rosela as $kps) { ?>
                                        <div class="col-sm">
                                            <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $kps['no_aksesi']; ?>" readonly>
                ...
                <div role="tabpanel" class="tab-pane" id="stok">
                    <?php foreach ($benih_rosela as $aks) { ?>

                    <form class="user" method="post" action="<?php echo base_url('edit_plant/edit_rosela/tambah_benih'); ?>">
                        <div class="col-sm">
                    ...
                    <div class="modal fade modalfoto" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" method="post" action="<?php echo base_url('add/add_rosela/tambah_benih2'); ?>">
                                        <div class="form-group row">
                                            <?php  foreach ($dat_rosela as $kps) { ?>
                                            <div class="col-sm">
                                                <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $kps['no_aksesi']; ?>" readonly>
