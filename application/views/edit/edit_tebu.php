        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="paspor">
                    ...
                    <form class="user" method="POST" action="<?= base_url('edit_plant/edit_tebu/pas_tebu'); ?>">
                        <?php
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" method="post" action="<?php echo base_url('add/add_tebu/tambah_pas2'); ?>">
                                        <div class="form-group row">
                                            <?php  foreach ($dat_tebu as $kps) { ?>
                                            <div class="col-sm">
                ...
                <div role="tabpanel" class="tab-pane" id="foto">
                    ...
                    <?php
                        foreach ($foto_tebu as $pas) {
                        ?>
                    <!-- <form class="user" method="POST" action="<?= base_url('edit_plant/edit_tebu/tambah_foto'); ?>"> -->
                    <?= form_open_multipart('edit_plant/edit_tebu/tambah_foto'); ?>
                    <div class="form-group row">
                        <div class="col-sm">
                            <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $pas['no_aksesi']; ?>" readonly>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <?= form_open_multipart('add/add_tebu/tambah_foto2'); ?>
                                    <div class="form-group row">
                                        <?php  foreach ($dat_tebu as $kps) { ?>
                                        <div class="col-sm">
                                            <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $kps['no_aksesi']; ?>" readonly>
                ...
                <div role="tabpanel" class="tab-pane" id="stok">
                    <?php foreach ($benih_tebu as $aks) { ?>

                    <form class="user" method="post" action="<?php echo base_url('edit_plant/edit_tebu/tambah_benih'); ?>">
                        <div class="col-sm">
                    ...
                    <div class="modal fade modalfoto" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="user" method="post" action="<?php echo base_url('add/add_tebu/tambah_benih2'); ?>">
                                        <div class="form-group row">
                                            <?php  foreach ($dat_tebu as $kps) { ?>
                                            <div class="col-sm">
                                                <input class="form-control" type="text" id="no_aksesi" name="no_aksesi" value="<?= $kps['no_aksesi']; ?>" readonly>
