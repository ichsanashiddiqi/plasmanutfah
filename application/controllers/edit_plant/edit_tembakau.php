<?php
class edit_tembakau extends CI_Controller
{
    ...
    function kar_tembakau()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_tembakau');
        redirect('tanaman/edit_tembakau');
    }

    function pas_tembakau()
    {
        $no_aksesi = $this->input->post('no_aksesi');
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_tembakau');
        redirect('tanaman/edit_tembakau' . $no_aksesi);
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'foto_tembakau');
        redirect('tanaman/edit_tembakau');
    }
}
