<?php
class Edit_agave extends CI_Controller
{
    ...
    function kar_agave()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_agave');
        redirect('tanaman/edit_agave/' . $no_aksesi);
    }
    ...
    function pas_agave()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_agave');
        redirect('tanaman/edit_agave' . $no_aksesi);
    }
