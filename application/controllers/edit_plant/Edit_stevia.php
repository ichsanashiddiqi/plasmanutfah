<?php
class Edit_stevia extends CI_Controller
{
    ...
    function kar_stevia()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_stevia');
        redirect('tanaman/edit_stevia/' . $no_aksesi);
    }
    ...
    function pas_stevia()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_stevia');
        redirect('tanaman/edit_stevia' . $no_aksesi);
    }
