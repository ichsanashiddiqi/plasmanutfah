<?php
class Edit_gulabit extends CI_Controller
{
    ...
    function kar_gulabit()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_gulabit');
        redirect('tanaman/edit_gulabit/' . $no_aksesi);
    }

    function pas_gulabit()
    {
        $no_aksesi = $this->input->post('no_aksesi');
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_gulabit');
        redirect('tanaman/edit_gulabit' . $no_aksesi);
    }
