<?php
class Edit_jarak_kepyar extends CI_Controller
{
    ...
    function kar_jarak_kepyar()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_jarak_kepyar');
        redirect('tanaman/edit_jarak_kepyar/' . $no_aksesi);
    }

    function pas_jarak_kepyar()
    {
        $no_aksesi = $this->input->post('no_aksesi');
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_jarak_kepyar');
        redirect('tanaman/edit_jarak_kepyar' . $no_aksesi);
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_jarak_kepyar');
        redirect('tanaman/edit_jarak_kepyar');
    }
}
