<?php
class edit_kapuk extends CI_Controller
{
    ...
    function kar_kapuk()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_kapuk');
        redirect('tanaman/edit_kapuk');
    }
    ...
    function pas_kapuk()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_kapuk');
        redirect('tanaman/edit_kapuk' . $no_aksesi);
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'foto_kapuk');
        redirect('tanaman/edit_kapuk');
    }
}
