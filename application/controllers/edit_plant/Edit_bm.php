<?php
class Edit_bm extends CI_Controller
{
    ...
    function kar_bm()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_bunga_matahari');
        redirect('tanaman/edit_bm');
    }
    ...
    function pas_bm()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_bunga_matahari');
        redirect('tanaman/edit_bm' . $no_aksesi);
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'foto_bunga_matahari');
        redirect('tanaman/edit_bm');
    }
}
