<?php
class Edit_rosela extends CI_Controller
{
    ...
    function kar_rosela()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'dat_rosela');
        redirect('tanaman/edit_rosela/' . $no_aksesi);
    }
    ...
    function pas_rosela()
    {
        ...
        $this->m_edit_data->update_data($where, $data, 'pas_rosela');
        redirect('tanaman/edit_rosela' . $no_aksesi);
    }
