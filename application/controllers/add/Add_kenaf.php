<?php
class Add_kenaf extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_kenaf.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_kenaf.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            ...
            $this->m_add_data->input_data($data, 'dat_kenaf');
            redirect('tambah/kenaf2');
        }
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_kenaf');
        redirect('tambah/kenaf2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_kenaf');
        redirect('tambah/kenaf2');
    }
    ...
    function tambah_pas2()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_kenaf');
