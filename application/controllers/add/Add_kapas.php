<?php
class Add_kapas extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_kapas.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_kapas.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                'no_aksesi' =>  htmlspecialchars($no_aksesi),
                'no_aksesi_IDN' => $no_aksesi_IDN,
                'nama_aksesi' => htmlspecialchars($nama_aksesi),
                'Propinsi' => $Propinsi,
                'Kabupaten' => $Kabupaten,
                'Kecamatan' => $Kecamatan,
                'Desa' => $Desa,
    ...
    function tambah_pas()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_kapas');
        redirect('tambah/kapas2');
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_kapas');
        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Data Berhasil Ditambahkan</div>');
        redirect('tambah/kapas2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_kapas');
        redirect('tambah/kapas2');
    }
