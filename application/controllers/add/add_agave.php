<?php
class Add_agave extends CI_Controller
{
    ...
    function tambah_aksi()
    {
        ...
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_agave.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_agave.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            ...
            $this->m_add_data->input_data($data, 'dat_agave');
            redirect('tambah/agave2');
        }
    }
    ...
    function tambah_pas()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_agave');
        redirect('tambah/agave2');
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_agave');
        redirect('tambah/agave2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_agave');
        redirect('tambah/agave2');
    }
}
