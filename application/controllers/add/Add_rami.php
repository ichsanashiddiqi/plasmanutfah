<?php
class Add_rami extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_rami.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_rami.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            ...
            $this->m_add_data->input_data($data, 'dat_rami');
            redirect('tambah/rami2');
        }
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_rami');
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_rami');
        redirect('tambah/rami2');
    }
    ...
    function tambah_pas2()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_rami');
