<?php
class Add_gulabit extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_gulabit.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_gulabit.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            ...
            $this->m_add_data->input_data($data, 'dat_gulabit');
            redirect('tambah/gulabit2');
        }
    }
    ...
    function tambah_pas()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_gulabit');
        redirect('tambah/gulabit2');
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_gulabit');
        redirect('tambah/gulabit2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_gulabit');
        redirect('tanaman/gulabit2');
    }
