<?php
class Add_kapuk extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_kapuk.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_kapuk.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            ...
            $this->m_add_data->input_data($data, 'dat_kapuk');
            redirect('tambah/kapuk2');
        }
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_kapuk');
        redirect('tambah/kapuk2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_kapuk');
        redirect('tambah/kapuk2');
    }
    ...
    function tambah_pas2()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_kapuk');
