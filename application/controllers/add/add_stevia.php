<?php
class Add_stevia extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('no_aksesi', 'No_aksesi', 'required|trim|is_unique[dat_stevia.no_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        $this->form_validation->set_rules('nama_aksesi', 'Nama_aksesi', 'required|trim|is_unique[dat_stevia.nama_aksesi]', [
            'is_unique' => 'Nomor Aksesi sudah digunakan!',
            'required' => 'Mohon form untuk diisi'
        ]);
        if ($this->form_validation->run() == false) {
            $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
            $data['idkar'] = $this->db->get('tab_satevia')->result_array();
            ...
            $this->m_add_data->input_data($data, 'dat_stevia');
            redirect('tambah/stevia2');
        }
    }
    ...
    function tambah_pas()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_stevia');
        redirect('tambah/stevia2');
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_stevia');
        redirect('tambah/stevia2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_stevia');
        redirect('tambah/stevia2');
    }
}
