<?php
class Add_tembakau extends CI_Controller
{
    ...
    function tambah_aksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('tambah/tambah_tembakauapas.php', $data);
            ...
            $this->m_add_data->input_data($data, 'dat_tembakau');
            redirect('tambah/tembakau2');
        }
    }
    ...
    function tambah_foto()
    {
        ...
        $this->m_add_data->input_data($data, 'foto_tembakau');
        redirect('tambah/tembakau2');
    }
    ...
    function tambah_benih()
    {
        ...
        $this->m_add_data->input_data($data, 'benih_tembakau');
        redirect('tambah/tembakau2');
    }
    ...
    function tambah_pas2()
    {
        ...
        $this->m_add_data->input_data($data, 'pas_tembakau');
